...
const ColorPicker: React.FC<ColorPickerProps> = ({ onColorChange, defaultColor }) => {
	...
	const colors = [NoteColor.YELLOW, NoteColor.GREEN, NoteColor.BLUE, NoteColor.PINK];
	...
	return (
		<>
			...
			<Box
				...
				<Image src="/assets/colorPicker_select_color.svg" alt="colorPicker_select_color" fill />
			</Box>
			<Box
				sx={{
					width: '278px',
				...
				<Image src="/assets/stage5_choose_color.svg" alt="stage5_choose_color" fill />
			</Box>
		</>
	);
};
